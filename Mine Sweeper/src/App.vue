...
<template>
    ...
    <div class="container mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      <div class="grid grid-cols-4 gap-4 mb-6">
        ...
        <button v-for="(board,index) in BoardData" class="cell bg-gray-300 border border-gray-400 p-4" v-text="board"  :class="{'bg-red-500':board.isSelected}"  @click="select(index)"></button>
      ...
      <div class="flex justify-center">
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Reset</button>
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Reset</button>      </div>
    </div>
  </div>
